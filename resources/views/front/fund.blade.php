        ...
        <div class="container">
            <div class="slider">
                <div class="slide">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <img class="w-100" src="{{ asset('assets/front/Images/') }}/medicalFundraising/agentLeah.jpg" alt="Assets/Images/medicalFundraising/agentLeah.jpg"></img>
                        </div>
                    </div>
                </div>
                <div class="slide">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <img class="w-100" src="{{ asset('assets/front/Images/') }}/medicalFundraising/agentJenna.jpg" alt="Assets/Images/medicalFundraising/agentJenna.jpg"></img>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 m-auto text-center mt-4">
                ...
                <div class="col-lg-4 m-auto">
                    <div class="loadMore">
                        <a class="shadow" href="javascript:void(0)">Contact us</a>
                    </div>
                </div>
            </div>
        </div>
