                            ...
                            <div class="col-lg-10 m-auto">
                                ...
                                <div class="donaterInfo">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <hr>
                                        <div class="col-lg-12">
                                            <label for="CreditOrDebitNumber" class="form-label">Credit or Debit Number</label>
                                            <input type="number" class="form-control" id="CreditOrDebitNumber" placeholder="1234 1234 1234 1234">
                                        </div>
                                        <div class="col-lg-12">
                                            <label for="ExpirationDate" class="form-label">Expiration Date</label>
                                            <input type="number" class="form-control" id="ExpirationDate" placeholder="MM / YY">
                                        </div>
                                        <div class="col-lg-6">
                                            <label for="SecurityCode" class="form-label">Security Code</label>
                                            <input type="number" class="form-control" id="SecurityCode" placeholder="CVC">
                                        </div>
                                        <small>Enter 3-digits on back of card. AmEx uses front 4-digit code.</small>
                                    </div>
                                </div>
                                <div class="col-lg-3 m-auto">
                                    <a class="startedBtn mt-0 mb-0 text-light" href="javascript:void(0)">Donate Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
