            ...
            <div class="row">
                <div class="col-lg-6 mt-5 mb-5 pt-5">
                    <div class="discoverMainBanner">
                        ...
                        <h2><b>Discover volunteer fundraisers on Start Fundraising</b></h2>
                ...
                <div class="col-lg-6 m-auto">
                    <img class="w-100" src="Assets/Images/volunteerFundraiser/volunteerFundraiserImg01.jpg" alt="Assets/Images/volunteerFundraiser/volunteerFundraiserImg01.jpg">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="topFundraisers newFundraisers">
                <div class="col-lg-9 m-auto">
                    <h2>Browse volunteer fundraisers</h2>
                    <div class="row">
